...
route.put("/toggle_status/:id", (0, authorized_1.authorizeRoles)("admin", "user"), (0, authorized_1.checkProjectOrTaskRole)(["teamlead", "admin"]), (0, catchAsync_1.catchAsync)(Task_1.toggleTaskStatus));
