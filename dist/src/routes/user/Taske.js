...
route.get("/task/:taskId", (0, authorized_1.checkProjectOrTaskRole)(['member', 'membercanapprove', 'teamlead', 'admin']), (0, catchAsync_1.catchAsync)(taske_1.getusertaskattaskbyid));
